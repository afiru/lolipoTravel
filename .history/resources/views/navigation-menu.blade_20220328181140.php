<div class="pc_only pcheader bg-white lg:pb-12">
    <div class="max-w-screen-2xl px-2 md:px-8 mx-auto">
        <header class="flex justify-between items-center py-2 md:py-8">
            <a lass="inline-flex items-center text-black-800 md:text-3xl font-bold gap-2.5" aria-label="logo" href="{{ route('dashboard') }}">
